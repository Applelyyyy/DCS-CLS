...
|---|---|---|
| 68010321 | Nutthawat Charoensiriphong | Module A - Shell Core, FSM Parser และ File I/O |
| 68011000 | Warithnan Baibua | Module B - DES Key Schedule Generator |
| 68010697 | Panabordee Panitchakit | Module C - DES Feistel Core, ECB และ PKCS#7 |
| 68010713 | Punnawit Khamthorn | Module D - Hex Dump และสถิติความถี่ของ byte |
